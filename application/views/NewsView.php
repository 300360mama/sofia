...
class NewsView extends View{
	...
	function getAllContent(array $data=null){
		...
		switch ($action){
			case 'index':
				$this->getAllArticle($data['article'],$data['page'], $data['controller']);
				$this->getAside($data);
				break;
			case 'article':
 ...
 */
	private function getAllArticle($article,$page, $controller){
	 ...
	 *
	 * */
	public function getPage($article,$page=1, $controller){
